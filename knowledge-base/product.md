...
Phase 1 implements a single-page foundation with hero, approach, inspiration, promise, contact-preview, and footer sections. The later content hierarchy remains Home, How We Work, Travel Inspiration, Our Journeys, About, Plan Your Journey, Contact, Privacy, and Terms.
...
## How it is tested
Review the rendered mobile and desktop pages against this document. Automated tests should cover navigation labels, CTA destinations, and form validation; final copy requires human approval.
